...
def run(landmaker_path: str, model: str, num_faces: int,
  ...
  """
    ...
    base_options = python.BaseOptions(model_asset_path=landmaker_path)
...
def main(landmaker_path):
    ...
    parser.add_argument(
        '--frameHeight',
        help='Height of frameav to capture from camera.',
        required=False,
        default=960)
    args = parser.parse_args()

    run(landmaker_path, args.model, int(args.numFaces), args.minFaceDetectionConfidence,
        args.minFacePresenceConfidence, args.minTrackingConfidence,
        int(args.cameraId), args.frameWidth, args.frameHeight)


if __name__ == '__main__':
    # Provide the path to the model file here
    landmaker_path = 'support/face_landmarker.task'
    main(landmaker_path)